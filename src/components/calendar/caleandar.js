/*
  ...
  (◠‿◠✿)
*/
var Calendar = function(model, options, date, lang, urlEvents){
...
function createCalendar(calendar, element, adjuster, lang, urlEvents){
  ...
  var monthDefault = ["January", "February", "March", "April", "May", "June", "July", "Agosto", "September", "October", "November", "December"];
  ...
  function AddDays(){
    ...
    for(var i = 0; i < calendar.Selected.Days; i++){
      ...
      console.log( 'calendar: ', calendar.Model.Date )
      ...
      for(var n = 0; n < calendar.Model.length; n++){
        ...
        console.log( 'evDate 1: ', evDate.getTime() )
