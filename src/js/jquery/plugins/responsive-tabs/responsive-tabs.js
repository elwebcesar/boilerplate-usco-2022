...
(function($) {
    ...
    $tabSets.keydown(function(e){
      console.log('keydown'+e.keyCode);

      const element = document.activeElement;
      // console.log('element: ', element.textContent)
      // console.log('next element: ', element.nextElementSibling.textContent)
      // console.log('prev element: ', element.previousElementSibling.textContent)
